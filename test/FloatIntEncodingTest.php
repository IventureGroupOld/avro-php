...
class FloatIntEncodingTest extends PHPUnit\Framework\TestCase
{
    ...
    public static $FLOAT_NAN;
    public static $FLOAT_POS_INF;
    public static $FLOAT_NEG_INF;
    public static $DOUBLE_NAN;
    public static $DOUBLE_POS_INF;
    public static $DOUBLE_NEG_INF;

    public static $LONG_BITS_NAN;
    public static $LONG_BITS_POS_INF;
    public static $LONG_BITS_NEG_INF;
    public static $INT_BITS_NAN;
    public static $INT_BITS_POS_INF;
    public static $INT_BITS_NEG_INF;
    ...
    public function test_special_values()
    {
        ...
        $this->assertTrue(is_float(self::$DOUBLE_NAN), 'double NaN is a double');
        ...
        $this->assertTrue(is_float(self::$DOUBLE_POS_INF), 'double pos infinity is a double');
        ...
        $this->assertTrue(is_float(self::$DOUBLE_NEG_INF), 'double neg infinity is a double');
