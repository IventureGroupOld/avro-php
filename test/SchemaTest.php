...
class SchemaExample
{
     ...
     * @param null $comment
     */
    public function __construct($schema_string, $is_valid, $normalized_schema_string = null,
...
class SchemaTest extends PHPUnit_Framework_TestCase
{
    ...
    public static $valid_examples = array();
...
', false);
    ...
    /**
     * Do not test PHP, test units
     */
    public function no_test_json_decode()
    {
        ...
        foreach (array('true', 'True', 'TRUE', 'tRue') as $truthy) {
            $this->assertEquals(true, json_decode($truthy, true), $truthy . ' should be true');
        }
     ...
     * @param $example
     */
    public function test_parse($example)
    {
