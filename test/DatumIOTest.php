...
class DatumIOTest extends PHPUnit\Framework\TestCase
{
     ...
     * @param $binary
     */
    public function test_datum_round_trip($schema_json, $datum, $binary)
    {
     ...
     * @return array
     */
    public function default_provider()
    {
     ...
     * @param $default_value
     */
    public function test_field_default_value($field_schema_json,
